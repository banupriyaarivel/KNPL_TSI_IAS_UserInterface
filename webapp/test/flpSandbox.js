		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "KNPL TSI IAS USER",
									"targetURL": "#knpltsiiasfrontend-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"knpltsiiasfrontend-display": {
								"semanticObject": "knpltsiiasfrontend",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=knpltsiiasfrontend",
									"url": sap.ui.require.toUrl("knpltsiiasfrontend")
								}
							}
						}
					}
